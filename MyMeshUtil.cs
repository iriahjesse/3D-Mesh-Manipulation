...
namespace XRC.Assignments.Meshes
{
    public class MyMeshUtil
    {
            ...
            ModificationRegion regionOfInterest)
        {
            ...
            Vector3[] vertices = inputMesh.vertices; // Get vertices
            ...
            Vector3 translation, Vector3 rotation, Vector3 scale)
        {
            ...
            transformedVertices = (Vector3[])vertices.Clone();
            ...
            {
                transformedVertices[idx] = matrix.MultiplyPoint3x4(vertices[idx]);
            }
            // </solution>
            ...
            Vector3[] normals, float magnitude)
        {
            ...
            foreach (int idx in selectedIndices)
            {
                transformedVertices[idx] += normals[idx] * magnitude;
            }
            // </solution>
